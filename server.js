...
function test_link_click() {
  let json = page("Test Link Click",[
    ...
    "Plugins provide about pages that are silly and are also hidden from the sitemap but available from the origin on every site with the plugin installed or from collaborators.",
